...
const QMetaObject NodeEditor::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NodeEditor.data,
      qt_meta_data_NodeEditor,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *NodeEditor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NodeEditor.stringdata0))
        return static_cast<void*>(const_cast< NodeEditor*>(this));
